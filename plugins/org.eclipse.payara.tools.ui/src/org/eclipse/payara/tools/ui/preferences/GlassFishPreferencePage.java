...
package org.eclipse.payara.tools.ui.preferences;
...
public class GlassFishPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		addField(new BooleanFieldEditor(ENABLE_LOG, "&Enable Payara Plugin Log information in the IDE log file",
				getFieldEditorParent()));
		addField(new BooleanFieldEditor(ENABLE_START_VERBOSE,
				"&Start Payara Server in verbose mode (the Eclipse console can be used)", getFieldEditorParent()));

		addField(new BooleanFieldEditor(ENABLE_COLORS_CONSOLE, "Enable colored rendering in the Payara Log Viewer",
				getFieldEditorParent()));
	}
