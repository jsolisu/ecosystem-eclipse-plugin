 ...
 *
 * NOTE: This is a copy of the file used in the NB V3 plugin, though it's in a
 * different package there (org.netbeans.modules.glassfish.javaee.db).
 *
...
public class DriverMaps {
	...
	public static final String getUrlPrefix(String inClass, String resType) {
		return resType.equals("javax.sql.ConnectionPoolDataSource") ? getPrefix(cpClassMap, inClass)
				: getPrefix(dsClassMap, inClass);
	}
	...
	static {
		...
		// driverMap.put("jdbc:microsoft:sqlserver:",
		...
		// Following four entries for drivers to be included in Java Studio Enterprise 7
		// (Bow)
	...
	static {
		...
		// Microsoft SQL Server (Weblogic driver)
		// dsClassMap.put("jdbc:weblogic:mssqlserver4:",
		...
		// Microsoft SQL Server 2005 (Microsoft driver)
		// dsClassMap.put("jdbc:microsoft:sqlserver:",
