...
public class JDBCWizard extends ResourceWizard {
	...
	private void doFinish(String jndiName, JDBCInfo jdbcInfo, IProject selectedProject, IProgressMonitor monitor)
	...
	public static String createFragment(String jndiName, JDBCInfo jdbcInfo, IProject selectedProject)
		...
		// TODO
		// Extend this to do a complete check of the pool attributes like url,
		// driverClass, datasourceClass
		// etc
