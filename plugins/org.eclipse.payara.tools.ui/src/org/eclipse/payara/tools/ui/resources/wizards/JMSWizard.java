...
public class JMSWizard extends ResourceWizard {
	...
	private void doFinish(String jndiName, JMSInfo jmsInfo, IProject selectedProject, IProgressMonitor monitor)
	 ...
	 */
	public static String createFragment(String jndiName, JMSInfo jmsInfo) throws CoreException {
