...
public class AddGenericResourceClassOperation extends NewWebClassOperation {
	...
	private void doGeneration(IProgressMonitor monitor, IPackageFragment fragment, Object tempImpl,
			AddGenericResourceTemplateModel tempModel) throws JavaModelException, JETException {
		try {
	...
	protected IFile createJavaFile(IProgressMonitor monitor, IPackageFragment fragment, String source, String className)
		...
		if (fragment != null) {
			...
			if (cu == null || !cu.exists()) {
				cu = fragment.createCompilationUnit(className, source, true, monitor);
			}
