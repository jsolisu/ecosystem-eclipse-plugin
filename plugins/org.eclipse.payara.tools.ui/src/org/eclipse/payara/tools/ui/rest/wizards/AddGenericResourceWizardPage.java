...
public class AddGenericResourceWizardPage extends NewWebClassWizardPage {
	...
	static {
		...
		patternStringToObject.put(Messages.patternTypeContainerValue,
				AddGenericResourceTemplateModel.CONTAINER_PATTERN);
		patternStringToObject.put(Messages.patternTypeClientContainerValue,
				AddGenericResourceTemplateModel.CLIENT_CONTAINER_PATTERN);
	}

	public AddGenericResourceWizardPage(IDataModel model, String pageName, String pageDesc, String pageTitle,
			String moduleType) {
	...
	protected Composite createTopLevelComposite(Composite parent) {
		...
		patternTypeCombo.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				model.setProperty(AddGenericResourceDataModelProvider.PATTERN, patternObject);
		...
		synchHelper.synchCombo(mimeTypeCombo, AddGenericResourceDataModelProvider.MIME_TYPE, null);
		populateCombos();
		new Label(composite, SWT.NONE); // placeholder so layout is correct
	...
	private void addContainerRepresentationClassGroup(Composite composite) {
		containerRepText = addRepresentationClassLabelAndTextGroup(composite,
				Messages.containerRepresentationClassLabel,
	 ...
	 */
	private Text addRepresentationClassLabelAndTextGroup(Composite composite, String repLabelString,
			String propertyName) {
	...
	protected void handleRepButtonPressed(String dialogTitle, String dialogLabel, Text repTextField) {
		...
		final IJavaSearchScope scope = TypeSearchEngine.createJavaSearchScopeForAProject(packRoot.getJavaProject(),
				true, true);
	...
	private void updateEnablementFromPattern() {
		boolean enableExtras = !model.getProperty(AddGenericResourceDataModelProvider.PATTERN)
				.equals(AddGenericResourceTemplateModel.SIMPLE_PATTERN);
