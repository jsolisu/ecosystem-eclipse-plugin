...
public class ContainerResourceTemplate {
	...
	protected static final String TEXT_18 = NL + NL + "    /**" + NL + "     * Default constructor. " + NL + "     */"
			+ NL + "    public ";
	...
	protected static final String TEXT_37 = NL + NL + "    /**" + NL
	...
	protected static final String TEXT_44 = NL + "     * @param content representation for the new resource" + NL
			+ "     * @return an HTTP response with content of the created resource" + NL + "     */" + NL + "    @POST"
			+ NL + "    @Consumes(\"";
	...
	public String generate(Object argument) {
		...
		/*
		 * This Content is provided under the terms and conditions of the Eclipse Public
