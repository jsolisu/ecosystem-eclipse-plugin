...
/**
 * This provides provides the dynamic nodes; the tree nodes that are inserted
 * underneath a running Payara / GlassFish server node in the Servers view.
 *
...
public class ServerViewDynamicNodeProvider extends BaseContentProvider implements ITreeContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof IServer) {
			...
			// Only active for a Payara or Glassfish 3.1.x server which is running, as we
			// query
			// the server dynamically for the various artefacts it has running and/or
			// available.
