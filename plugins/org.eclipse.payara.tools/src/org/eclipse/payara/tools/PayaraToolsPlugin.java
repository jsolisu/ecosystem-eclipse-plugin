...
/**
 * Payara Tools Server Plugin. This is used as the OSGi bundle activator, as
 * well as the central place to do logging.
 */
		...
		for (String[] command : commandsToExecuteAtExit) {
			try {
				...
				BufferedReader input = new BufferedReader(
						new InputStreamReader(getRuntime().exec(command).getInputStream(), defaultCharset()));
