...
enum GlassfishDescriptorType {
	...
	static {
		ROOT_MODEL_ELEMENT_TYPE_TO_DESCRIPTOR_TYPE.put(IGlassfishDeploymentDescriptorModel.TYPE,
				GlassfishDescriptorType.GF_WEB);
		ROOT_MODEL_ELEMENT_TYPE_TO_DESCRIPTOR_TYPE.put(IGlassfishEjbDescriptorModel.TYPE,
...
class GlassfishRootElementInfo {
	...
	GlassfishRootElementInfo(final String namespace, final String schemaLocation, final String rootElementName) {
