...
/**
 * This class provides an adapter for the generated implementation of
 * {@link IPayaraRuntimeModel}, which maps the getters/setters to the attributes
 * of an {@link IServerWorkingCopy}.
 * 
 * <p>
 * Usage example:
 * 
...
/**
 * Value binding that binds the read and write operations for a property to a
 * working copy's get- and set attributes.
 * 
 */
