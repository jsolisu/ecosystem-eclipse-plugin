...
public enum TaskEvent {
	...
	CMD_FAILED,
	/**
	 * Authorization failed on HTTP protocol level (401 or 403 response). This is
	 * usually handled by java.net.Authenticator.
	 */
	AUTH_FAILED_HTTP,
	/**
	...
	/**
	 * Returns a <code>TaskEvent</code> with a value represented by the specified
	 * <code>String</code>. The <code>TaskEvent</code> returned represents existing
	 * value only if specified <code>String</code> matches any <code>String</code>
	 * returned by <code>toString</code> method. Otherwise <code>null</code> value
	 * is returned.
	 * <p>
	 *
	 * @param eventStr Value containing <code>TaskEvent</code> <code>toString</code>
	 *                 representation.
	 * @return <code>TaskEvent</code> value represented by <code>String</code> or
