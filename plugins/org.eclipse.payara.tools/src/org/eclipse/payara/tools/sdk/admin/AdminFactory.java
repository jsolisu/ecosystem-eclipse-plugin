 ...
 * <p/>
 * Selects correct GlassFish server administration functionality depending on
 * given GlassFish server entity object.
 * <p/>
 *
...
public abstract class AdminFactory {
	...
	/**
	 * Creates specific <code>AdminFactory</code> child class instance to build
	 * GlassFish server administration command runner and data objects based on
	 * provided GlassFish server version.
	 * <p>
	 *
	 ...
	 * Creates specific <code>AdminFactory</code> child class instance to build
	 * GlassFish server administration command runner and data objects based on
	 * provided GlassFish server administration interface type.
	 * <p/>
	 *
	...
	/**
	 * Build runner for command interface execution and connect it with provided
	 ...
	 */
	Runner newRunner(PayaraServer payaraServer, Command command, Class<? extends Runner> runnerClass)
