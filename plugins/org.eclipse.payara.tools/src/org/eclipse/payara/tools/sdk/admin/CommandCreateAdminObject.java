...
/**
 * Command that creates administered object with the specified JNDI name and the
...
public class CommandCreateAdminObject extends Command {
	...
	/**
	 * Constructs an instance of GlassFish server create administered object command
	 * entity.
	 * <p/>
	 *
	 * @param jndiName   The JNDI name of this JDBC resource.
	 * @param resType    Resource type.
	 * @param raName     The name of the resource adapter associated with this
	 *                   administered object.
	 * @param properties Optional properties for configuring the pool.
	 * @param enabled    If this object is enabled.
	 */
	public CommandCreateAdminObject(final String jndiName, final String resType, final String raName,
