...
/**
 * Command that creates connector resource with the specified JNDI name and the
 * interface definition for a resource adapter on server.
 * <p/>
 *
...
public class CommandCreateConnector extends CommandTarget {
	...
	/**
	 * Constructs an instance of GlassFish server create connector resource command
	 * entity.
	 * <p/>
	 *
	 ...
	 * @param target     Name of the cluster or instance where the resource will be
	 *                   created.
	 */
	public CommandCreateConnector(final String jndiName, final String poolName, final Map<String, String> properties,
			final boolean enabled, final String target) {
