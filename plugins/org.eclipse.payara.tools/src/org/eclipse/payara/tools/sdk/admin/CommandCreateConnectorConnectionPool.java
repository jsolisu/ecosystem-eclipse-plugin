...
public class CommandCreateConnectorConnectionPool extends Command {
	 ...
	 * <td><i>Deprecated.</i> Use the equivalent option. Default value is
	 * false.</td>
	 * </tr>
	 * <tr>
	...
	/**
	 * Constructs an instance of GlassFish server create EIS connection pool command
	 * entity.
	 * <p/>
	 *
	 ...
	 */
	public CommandCreateConnectorConnectionPool(final String poolName, final String raName,
			final String connectionDefinition, final Map<String, String> properties) {
		super(COMMAND);
