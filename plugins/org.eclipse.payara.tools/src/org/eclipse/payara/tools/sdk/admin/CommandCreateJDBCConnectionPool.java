...
public class CommandCreateJDBCConnectionPool extends Command {
	 ...
	 * @param dataSourceClassName The name of the vendor-supplied JDBC data source
	 *                            resource manager.
	 ...
	 *                            execution.
	 */
	public static ResultString createJDBCConnectionPool(final PayaraServer server, final String connectionPoolId,
			final String dataSourceClassName, final String resType, final Map<String, String> properties)
			throws PayaraIdeException {
		Command command = new CommandCreateJDBCConnectionPool(connectionPoolId, dataSourceClassName, resType,
				properties);
	...
	public static ResultString createJDBCConnectionPool(final PayaraServer server, final String connectionPoolId,
		...
		try {
			...
			throw new PayaraIdeException(ERROR_MESSAGE + " in " + timeout + "ms", te);
		}
	}
	 ...
	 * <tr>
	 * <td><b>port</b></td>
	 * <td>Specifies the port on which the database server listens for
	 * requests.</td>
	 * </tr>
	 * <tr>
	 ...
	 * <td>Specifies an underlying XADataSource, or a ConnectionPoolDataSource if
	 * connection pooling is done.</td>
	 * </tr>
	 * <tr>
	 ...
	 * <tr>
	 * <td><b>url</b></td>
	 * <td>Specifies the URL for this connection pool. Although this is not a
	 * standard property, it is commonly used.</td>
	 * </tr>
	 * <tr>
	 ...
	 * applications need not be re-enabled for the attribute or property changes to
	 * the pool to take effect. Any in-flight transaction's connection requests will
	 * be allowed to complete with the old pool configuration as long as the
	 * connection requests are within the timeout period, so as to complete the
	 * transaction. New connection requests will wait for the pool reconfiguration
	 * to complete and connections will be acquired using the modified pool
	 * configuration.</td>
	 * </tr>
	 * <tr>
	 * <td><b>LazyConnectionEnlistment</b></td>
	 * <td><i>Deprecated.</i> Use the equivalent attribute. The default value is
	 * false.</td>
	 * </tr>
	 * <tr>
	 * <td><b>LazyConnectionAssociation</b></td>
	 * <td>Deprecated.</i> Use the equivalent attribute. The default value is
	 * false.</td>
	 * </tr>
	 * <tr>
	 ...
	 * <td>Specifies whether pool resizer should validate idle connections before
	 * destroying and recreating them. The default value is true.</td>
	 * </tr>
	 * <tr>
	 * <td><b>time-to-keep-queries-in-minutes</b></td>
	 * <td>Specifies the number of minutes that will be cached for use in
	 * calculating frequently used queries. Takes effect when SQL tracing and
	 * monitoring are enabled for the JDBC connection pool. The default value is 5
	 * minutes.</td>
	 * </tr>
	 * <tr>
	 * <td><b>number-of-top-queries-to-report</b></td>
	 * <td>Specifies the number of queries to list when reporting the top and most
	 * frequently used queries. Takes effect when SQL tracing and monitoring are
	 * enabled for the JDBC connection pool. The default value is 10 queries.</td>
	 * </tr>
	 * </table>
	 */
	 ...
	 * @param properties          Optional properties for configuring the pool.
	 */
	public CommandCreateJDBCConnectionPool(final String connectionPoolId, final String dataSourceClassName,
			final String resType, final Map<String, String> properties) {
		super(COMMAND);
