...
public class CommandCreateJDBCResource extends Command {
	 ...
	 *                            execution.
	 */
	public static ResultString createJDBCResource(final PayaraServer server, final String connectionPoolId,
			final String jndiName, final String target, final Map<String, String> properties)
			throws PayaraIdeException {
		Command command = new CommandCreateJDBCResource(connectionPoolId, jndiName, target, properties);
	 ...
	 */
	public static ResultString createJDBCResource(final PayaraServer server, final String connectionPoolId,
			final String jndiName, final String target, final Map<String, String> properties, final long timeout)
			throws PayaraIdeException {
		Command command = new CommandCreateJDBCResource(connectionPoolId, jndiName, target, properties);
		Future<ResultString> future = ServerAdmin.<ResultString>exec(server, command);
		try {
	 ...
	 * <tr>
	 * <td><b>server</b></td>
	 * <td>Deploys the component to the default server instance. This is the default
	 * value.</td>
	 * </tr>
	 * <tr>
	 * <td><b>domain</b></td>
	...
	/**
	 * Constructs an instance of GlassFish server create JDBC resource command
	 * entity.
	 * <p/>
	 *
	 * @param connectionPoolId Connection pool unique name (and ID).
	 ...
	 */
	public CommandCreateJDBCResource(final String connectionPoolId, final String jndiName, final String target,
			final Map<String, String> properties) {
		super(COMMAND);
