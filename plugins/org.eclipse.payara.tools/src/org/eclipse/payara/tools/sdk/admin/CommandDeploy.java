...
public class CommandDeploy extends CommandTargetName {
	 ...
	 * @param application File object representing archive or directory to be
	 *                    deployed.
	...
	public static ResultString deploy(PayaraServer server, File application, TaskStateListener listener)
		...
		try {
			return ServerAdmin
					.<ResultString>exec(server, new CommandDeploy(null, null, application, null, null, null), listener)
					.get();
