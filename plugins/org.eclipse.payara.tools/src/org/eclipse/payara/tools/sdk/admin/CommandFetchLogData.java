...
public class CommandFetchLogData extends Command {
	 ...
	 * Constructs an instance of GlassFish server view log command entity.
	 * <p/>
	 * Only log entries added in particular interval starting from previous call
	 * that returned this value of <code>paramsAppendNext</code> will be returned.
	 * <p/>
	 *
	 * @param paramsAppendNext Interval query parameters from Last View Log command
	 *                         execution.
	 */
