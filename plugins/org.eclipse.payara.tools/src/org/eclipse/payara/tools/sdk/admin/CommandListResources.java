...
public class CommandListResources extends CommandTarget {
	 ...
	 *                            execution.
	 */
	public static ResultList<String> listResources(final PayaraServer server, final String cmdSuffix,
	...
	public static String command(String resourceCmdSuffix) {
		StringBuilder sb = new StringBuilder(
				COMMAND_PREFIX.length() + COMMAND_SUFFIX.length() + resourceCmdSuffix.length());
	...
	/**
	 * Constructs an instance of GlassFish server list JDBC resources command
	 * entity.
	 * <p/>
	 ...
	 *                <code>command</code> static method to build this string using
