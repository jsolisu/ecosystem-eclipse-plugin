 ...
 * <p/>
 * Contains common <code>name</code> and <code>target</code> attribute. Holds
 * data for command. Objects of this class are created by API user.
 * <p/>
 *
...
public abstract class CommandTargetName extends CommandTarget {
	 ...
	 * @param target  Target GlassFish instance or cluster where <code>name</code>
	 *                is stored.
	 */
