...
/**
 * GlassFish Administratio Command Result containing server log as
 * <code>List&ltString&gt</code> values.
 * <p/>
...
public class ResultLog extends Result<ValueLog> {
	 ...
	 * <code>List&ltString&gt</code> result value containing server log.
	 */
	ResultLog() {
		super();
	}
