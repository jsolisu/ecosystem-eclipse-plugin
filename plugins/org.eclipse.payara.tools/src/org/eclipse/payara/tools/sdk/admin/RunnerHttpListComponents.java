...
public class RunnerHttpListComponents extends RunnerHttpTarget {
	 ...
	 */
	public RunnerHttpListComponents(final PayaraServer server, final Command command) {
	...
	protected boolean processResponse() {
		...
		String[] components = resourcesAttr != null ? resourcesAttr.split(ServerUtils.MANIFEST_COMPONENTS_SEPARATOR)
				: null;
		...
		if (components != null) {
			for (String component : components) {
				...
				try {
					decodedComponent = URLDecoder.decode(component, JavaUtils.UTF_8.name());
