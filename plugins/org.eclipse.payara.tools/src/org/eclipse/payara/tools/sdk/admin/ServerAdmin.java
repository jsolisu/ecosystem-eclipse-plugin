...
public class ServerAdmin {
	 ...
	 * <p/>
	 *
	 * @param authenticator External authenticator for Payara servers to be
	 *                      supplied.
	 */
	...
	public static <E extends Result<?>> Future<E> exec(PayaraServer payaraServer, Command command) {
		return (Future<E>) AdminFactory.getInstance(payaraServer.getAdminInterface()).getRunner(payaraServer, command)
				.execute();
	}
	 ...
	 * @param listeners    Listeners that are called when command execution status
	 *                     changes.
	 */
	public static <E extends Result> Future<E> exec(PayaraServer payaraServer, Command cmd,
