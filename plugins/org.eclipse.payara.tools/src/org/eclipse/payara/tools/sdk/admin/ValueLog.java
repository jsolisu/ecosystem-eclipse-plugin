...
public class ValueLog {
	 ...
	 * <p/>
	 * <code>X-Text-Append-Next</code> header contains the entire URL to pass to the
	 * GET method to return the changes since the last call. You can use those URL
	 * parameters to construct URL to get all log entries that were added in
	 * particular interval starting from call that returned this result.
	 */
	 ...
	 * <p/>
	 * Entity is initialized with values stored in <code>Runner</code> internal
	 * attributes in <code>processResponse</code> method.
	 * <p/>
	 *
	...
	public String toString() {
		...
		if (lines != null) {
			...
			for (String line : lines) {
				length += line != null ? line.length() + lineSeparatorLength : lineSeparatorLength;
			}
