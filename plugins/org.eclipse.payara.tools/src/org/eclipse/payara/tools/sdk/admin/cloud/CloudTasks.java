...
public class CloudTasks {
	 ...
	 * @param application - File object representing archive or directory where the
	 *                    application is
	 * @param listener    - listener, that listens to command execution events
	 * @return result object with task status and message
	 */
	public static ResultString deploy(final PayaraServer server, final String account, final File application,
		...
		try {
			...
			throw new PayaraIdeException("Instance or cluster stop failed.", e);
		}
	}
}
