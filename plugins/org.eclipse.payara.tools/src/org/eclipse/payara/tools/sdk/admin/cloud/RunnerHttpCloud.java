...
public class RunnerHttpCloud extends RunnerHttp {
	 ...
	 */
	public RunnerHttpCloud(final PayaraServer server, final CommandCloud command) {
	 ...
	 */
	RunnerHttpCloud(final PayaraServer server, final Command command, final String query) {
	 ...
	 * @param query   Query string for this command.
	 */
	RunnerHttpCloud(final PayaraServer server, final Command command, final String path, final String query) {
