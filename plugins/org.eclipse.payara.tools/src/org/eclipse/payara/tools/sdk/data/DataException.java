...
public class DataException extends PayaraIdeException {
	...
	/**
	 * Exception for non existent GlassFish installation root directory. Requires 1
	 * directory argument.
	 */
	static final String SERVER_ROOT_NONEXISTENT = "GlassFish installation root directory {0} does not exist";

	/**
	 * Exception for non existent GlassFish home directory. Requires 1 directory
	 * argument.
	 */
