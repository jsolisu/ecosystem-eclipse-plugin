...
public enum GlassFishAdminInterface {
	...
	/**
	 * Returns a <code>GlassFishAdminInterface</code> with a value represented by
	 * the specified <code>String</code>. The <code>GlassFishAdminInterface</code>
	 ...
	 * @return <code>GlassFishAdminInterface</code> value represented by
	...
	public String toString() {
		...
		default:
			throw new DataException(DataException.INVALID_ADMIN_INTERFACE);
		}
	}
}
