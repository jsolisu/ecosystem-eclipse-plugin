...
import static org.eclipse.payara.tools.sdk.data.DataException.INVALID_CONTAINER;
...
public enum GlassFishContainer implements Comparator<GlassFishContainer> {
	...
	/**
	 * Returns a <code>GlassFishContainer</code> with a value represented by the
	 * specified <code>String</code>. The <code>GlassFishContainer</code> returned
	 ...
	 *                     representation.
	 * @return <code>GlassFishContainer</code> value represented by
	...
	public int compare(GlassFishContainer container1, GlassFishContainer container2) {
		return container1 != null && container2 != null ? container1.ordinal() - container2.ordinal()
				: container1 != null ? container2.ordinal() : container2 != null ? -container1.ordinal() : 0;
	}
