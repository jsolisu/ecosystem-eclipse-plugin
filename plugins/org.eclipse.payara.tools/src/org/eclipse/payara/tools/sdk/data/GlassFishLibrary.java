...
public class GlassFishLibrary {
	...
	public static class Maven {
		 ...
		 */
		public Maven(final String groupId, final String artifactId, final String version) {
	 ...
	 */
	public GlassFishLibrary(final String libraryID, final List<URL> classpath, final List<URL> javadocs,
			List<String> javadocLookups, final List<URL> sources, final List<Maven> maven) {
