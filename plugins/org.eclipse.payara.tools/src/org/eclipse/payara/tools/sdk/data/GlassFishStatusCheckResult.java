 ...
 * <p/>
 * There is also minimal algebra defined to support <code>AND</code> and
 * <code>OR</code>.
 * <p/>
 *
 * @author Tomas Kraus
...
public enum GlassFishStatusCheckResult {
	 ...
	 */
	public static GlassFishStatusCheckResult and(final GlassFishStatusCheckResult s1,
	 ...
	 * @param s2 Second operand.
	 */
	public static GlassFishStatusCheckResult or(final GlassFishStatusCheckResult s1,
			final GlassFishStatusCheckResult s2) {
	 ...
	 */
	public static GlassFishStatusCheckResult and(final GlassFishStatusCheckResult s1,
			final GlassFishStatusCheckResult s2, final GlassFishStatusCheckResult s3) {
