...
public class GlassFishAccountEntity implements GlassFishAccount {
	...
	/**
	 * GlassFish cloud user account name (display name in IDE). Used as key
	 * attribute.
	 */
	 ...
	 */
	public GlassFishAccountEntity(String name, String account, String userName, String userPassword, String url,
			GlassFishCloud cloudEntity) {
		this.name = name;
		this.url = url;
