 ...
 * <p/>
 * GlassFish cloud entity instance which is used when not defined externally in
 * IDE.
 * <p/>
 *
...
public class GlassFishCloudEntity implements GlassFishCloud {
	 ...
	 */
	public GlassFishCloudEntity(String name, String host, int port, PayaraServer localServer) {
		this.name = name;
		this.host = host;
		this.port = port;
