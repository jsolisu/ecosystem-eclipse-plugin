...
public final class JDK {
	...
	public static boolean isCorrectJDK(Version version, Optional<String> vendor, Optional<Version> minVersion,
	...
	private static void initialize() {
		...
		/*
		 * In JEP 223 java.specification.version will be a single number versioning ,
		 * not a dotted versioning . So if we get a single integer as versioning we know
		 * that the JDK is post JEP 223 For JDK 8: java.specification.version 1.8
		 * java.version 1.8.0_122 For JDK 9: java.specification.version 9 java.version
		 * 9.1.2
		 */
