 ...
 * <p/>
 * Allows to access Payara server features and libraries configuration XML file
 * using configuration XML file parser.
 * <p/>
...
public class GlassFishConfigXMLImpl implements GlassFishConfig {
	...
	/**
	 * Stores information whether GlassFish configuration XML file was already read
	 * and processed
	 */
