...
public enum JavaEEProfile {
	 ...
	 */
	private static String[] createNames(final JavaEEProfile profile) throws ServerConfigException {
		String[] names;
		StringBuilder sb = new StringBuilder(
				profile.version.toString().length() + 1 + profile.type.toString().length());
		...
		default:
			throw new ServerConfigException(ServerConfigException.INVALID_EE_PLATFORM_TYPE);
		}
		return names;
	}
	 ...
	 * represents existing value only if specified <code>String</code> matches any
	 * <code>String</code> returned by <code>toString</code> method. Otherwise
	 * <code>null</code> value is returned.
	 * <p>
	 *
	 * @param name Value containing <code>JavaEEProfile</code> <code>toString</code>
	 *             representation.
	 * @return <code>JavaEEProfile</code> value represented by <code>String</code>
	...
	/**
	 * Returns a <code>JavaEEProfile</code> with a value represented by the
	 * specified <code>version</code> and <code>type</code> <code>String</code>s.
	 * The <code>JavaEEProfile</code> returned represents existing value only if
	 ...
	 *                <code>toString</code> representation.
	 * @return <code>JavaEEProfile</code> value represented by code>version</code>
	 *         and <code>type</code> <code>String</code> or <code>null</code> if
	 *         value was not recognized.
	 */
	public static JavaEEProfile toValue(final String version, final String type) {
	 ...
	 */
	private JavaEEProfile(final Version version, final Type type, final String name) {
