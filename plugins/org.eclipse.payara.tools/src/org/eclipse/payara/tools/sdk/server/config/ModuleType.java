...
public enum ModuleType {
	...
	/**
	 * Returns a <code>ModuleType</code> with a value represented by the specified
	 * <code>String</code>. The <code>ModuleType</code> returned represents existing
	 ...
	 * @return <code>ModuleType</code> value represented by <code>String</code> or
	...
	public String toString() {
		...
		default:
			throw new ServerConfigException(ServerConfigException.INVALID_MODULE_TYPE_NAME);
		}
	}
}
