...
/**
 * Reads configuration of http listeners from domain.xml. For each http listener
 * returns one {@link HttpData} object that contains name of listener, port
 * number and information whether this listener is secured.
 * <p/>
 *
