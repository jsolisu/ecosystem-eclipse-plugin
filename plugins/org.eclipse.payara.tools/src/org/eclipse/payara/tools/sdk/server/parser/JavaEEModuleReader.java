...
public class JavaEEModuleReader extends AbstractReader {
	...
	/**
	 * Creates an instance of <code>module</code> Java EE configuration XML element
	 * reader.
	 * <p/>
	 *
	...
	public void readAttributes(final String qname, final Attributes attributes) throws SAXException {
		modules.add(new Module(attributes.getValue(TYPE_ATTR), attributes.getValue(CHECK_ATTR)));
	}
