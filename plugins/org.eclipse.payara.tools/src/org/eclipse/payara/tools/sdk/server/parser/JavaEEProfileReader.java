...
public class JavaEEProfileReader extends AbstractReader {
	...
	/**
	 * Creates an instance of <code>profile</code> Java EE configuration XML element
	 * reader.
	 * <p/>
	 *
	...
	public void readAttributes(final String qname, final Attributes attributes) throws SAXException {
		profiles.add(new Profile(attributes.getValue(VERSION_ATTR), attributes.getValue(TYPE_ATTR),
