...
/**
 * This class represents the specific type of runtime associated with the server
 * that we implement; Payara / GlassFish.
 *
 * <p>
 * A few methods from RuntimeDelegate are overridden here, while a whole slew of
 * central runtime like functionality is put here as well.
 * </p>
 *
 * <p>
...
public final class PayaraRuntime extends RuntimeDelegate implements IJavaRuntime {
	...
	private static String createDefaultRuntimeName(String baseName, int counter) {
		...
		if (counter != 1) {
			runtimeName.append(" (").append(counter).append(')');
		}
